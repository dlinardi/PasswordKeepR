...
const generatePassword = (inputLength = 20, allowLowerCase = false, allowUpperCase = false, allowDigits = false, allowSymbols = false) => {
  // Options in function defualt to false HOWEVER form to select options defualts to ALL OPTIONS seleceted.
